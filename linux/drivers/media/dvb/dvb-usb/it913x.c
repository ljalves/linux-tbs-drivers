	...
	struct dvb_usb_device_properties *props)
{
	...
	case 0x9005 /* USB_PID_ITETECH_IT9135_9005 */:
	...
	struct dvb_usb_device_properties *props)
{
	...
	if (udev->speed != USB_SPEED_HIGH) {
		props->adapter[0].pid_filter_count = 5;
		...
		if(props->adapter[0].pid_filter_count == 5)
			props->adapter[0].pid_filter_count = 31;

	/* Select Stream Buffer Size and pid filter option*/
	if (pid_filter) {
		props->adapter[0].stream.u.bulk.buffersize =
			TS_BUFFER_SIZE_MAX;
		props->adapter[0].caps &=
	...
	if (it913x_config.dual_mode) {
		props->adapter[1].stream.u.bulk.buffersize =
			props->adapter[0].stream.u.bulk.buffersize;
		props->num_adapters = 2;
		if (pid_filter)
			props->adapter[1].caps =
				props->adapter[0].caps;
	} else
...
static int it913x_frontend_attach(struct dvb_usb_adapter *adap)
{
	...
	u16 ep_size = adap->props.stream.u.bulk.buffersize / 4;
	u8 pkt_size = 0x80;
...
static struct usb_device_id it913x_table[] = {
	{ USB_DEVICE(USB_VID_KWORLD_2, 0xe409 /* USB_PID_KWORLD_UB499_2T_T09 */) },
	{ USB_DEVICE(0x048d /* USB_VID_ITETECH */, 0x9135 /* USB_PID_ITETECH_IT9135 */) },
	{ USB_DEVICE(USB_VID_KWORLD_2, 0xe411 /* USB_PID_SVEON_STV22_IT9137 */) },
	{ USB_DEVICE(0x048d /* USB_VID_ITETECH */, 0x9005 /* USB_PID_ITETECH_IT9135_9005 */) },
	{ USB_DEVICE(0x048d /* USB_VID_ITETECH */, 0x9006 /* USB_PID_ITETECH_IT9135_9006 */) },
	{}		/* Terminating entry */
};
